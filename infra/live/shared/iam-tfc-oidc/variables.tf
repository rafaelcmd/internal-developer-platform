...
variable "tfc_allowed_subs" {
  description = "List of allowed OIDC subject claims for Terraform Cloud (e.g., organization:org:project:project:workspace:*)"
  type        = list(string)
  default = [
    "organization:internal-developer-platform-org:project:default:workspace:*"
  ]
}
