// Package logger provides structured logging for the provisioner.
// It wraps logrus behind a small interface so the provisioner and the API share
// the same logging API, field conventions, and OTLP bridge wiring.
package logger
